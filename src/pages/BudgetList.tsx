      ...
      {filteredBudgets.length === 0 ? (
        <EmptyState
          title={
            budgets.length === 0
              ? "No Budgets Found"
              : `No ${activeTab === 'active' ? 'active' : activeTab === 'completed' ? 'completed' : ''} budgets`
          }
          description={
            budgets.length === 0
              ? "You don't have any budgets yet. Create your first budget to track your spending."
              : `You don't have any ${
                  activeTab === 'active' ? 'active' : activeTab === 'completed' ? 'completed' : ''
                } budgets.`
          }
          actionText={budgets.length === 0 ? "Create Budget" : "View All Budgets"}
          onAction={() => {
            if (budgets.length === 0) {
            ...
            >
              <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <div className="flex justify-between items-start">
                  <div>
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{budget.name}</h2>
              ...
              <div className="px-6 py-4">
                ...
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-md text-gray-900 dark:text-gray-100">
                    {formatCurrency(budget.spent || 0, currentAccount.baseCurrency)}
                  </span>
                </div>
                ...
                <div className="flex justify-between items-center mt-4 text-sm">
                  ...
                  <span className={`font-medium ${getBudgetStatusColor(budget)}`}>
...
export default BudgetList;2 className="text-red-800 dark:text-red-200 text-lg font-semibold">Error loading budgets</h2>
